...
from exp_att_val_transformer.vlm_img_caption_att_val_transformer_model import (
    ImgCaptionAttValTransformerModel,
)
...
class ImgLanguageAttValTransformerModel(nn.Module):
    def __init__(self, config: Config):
        super().__init__()
        self.config = config

        self.img_embedding = ImageEmbedding(config=config)
        self.img_transfomer = ImgAttValTransformer(config=config)
        ...
        self.text_transformer = TextAttValMaskedTransformer(config=config)
        ...
        self.img_caption_model = ImgCaptionAttValTransformerModel(
            config=config,
